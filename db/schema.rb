...
ActiveRecord::Schema.define(version: 2020_10_14_075503) do

  create_table "favorite_restaurants", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
